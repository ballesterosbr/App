...
public class BluetoothSerialService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BluetoothList.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(BluetoothList.MESSAGE_DEVICE_NAME);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothList.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
     ...
     * (or until cancelled).
     */
    private class AcceptThread extends Thread { // Hilo servidor
